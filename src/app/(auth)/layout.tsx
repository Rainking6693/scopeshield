  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50">
      ...
      <div className="flex min-h-screen items-center justify-center p-4">
        <div className="w-full max-w-md">
          ...
          <div className="mb-8 text-center">
            ...
            <h1 className="mt-4 text-3xl font-bold text-slate-900">ScopeShield</h1>
            <p className="mt-2 text-sm text-slate-600">
              AI-powered scope creep protection for freelancers
            </p>
          </div>
          ...
          <div className="mt-8 text-center text-xs text-slate-500">
            <p>© 2024 ScopeShield. Protecting freelancers from scope creep.</p>
          </div>
        </div>
      </div>
      ...
      <div className="absolute inset-x-0 top-[calc(100%-13rem)] -z-10 transform-gpu overflow-hidden blur-3xl sm:top-[calc(100%-30rem)]">
        <div
          className="relative left-[calc(50%+3rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 bg-gradient-to-tr from-green-600 to-blue-600 opacity-20 sm:left-[calc(50%+36rem)] sm:w-[72.1875rem]"
          style={{
            clipPath:
              'polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)',
          }}
